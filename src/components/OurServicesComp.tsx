	...
	return (
		<div className="ourServices">
			...
			<div className="ourServices_text">
				<p>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus risus, velit enim semper vestibulum aliquet.
					Ultricies tempor ac curabitur ornare at nunc facilisis tincidunt nisl. Odio
				</p>
				<button className="btn2">All Services</button>
			</div>
				...
				<div className="ourServices_gridItem">
					...
					<div>
						...
						<p>
							...
							Arcu, non ornare commodo, convallis lectus. Proin scelerisque sed massa arcu nunc id ridiculus purus
							cursus. Luctus dolor et consequat nunc at ut.
						</p>
						<p>
							<Link href="/a">
								<a>
