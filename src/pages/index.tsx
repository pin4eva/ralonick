		...
		<>
			...
			<div>
				{isReady ? (
					...
					<FrontLayout>
						<div className="home" style={{ display: isReady ? "none" : "block" }}>
									...
									<div className="left">
										<div className="inner-left">
											...
											<div className="hero-text" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500">
												...
												<p>
													End to end service in the design, engineering, procurement, fabrication, installation, repair
													of (GRE), (GRP) and Vinylester Pipe system and products.
												</p>
												<Link href="/services">
								...
								<div className="quality-container-text">
									...
									<div className="quality-container-text-inner" data-aos="zoom-in-up" data-aos-duration="1000">
										...
										<div className="text-grid">
											...
											<p>
												Skill and competence are as important as practice therefore all staff are highly trained,
												possess high experiential knowledge in the field, and are highly professional. We value
												professionalism, to us it means giving clients the best value for their money.
											</p>
										</div>
										<div className="text-grid">
											<span>
											...
											<h5>Safety</h5>
											<p>
												As one of our offered service we are not lacking in ensuring that our installations and
												technical works are properly done. We have zero reservations as regards safety. Our staff are
												highly trained for personal & on-site safety.{" "}
											</p>
										</div>
									</div>
								</div>
